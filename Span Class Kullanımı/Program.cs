namespace Span_Class_Kullanımı
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Span<int> span4 = sayilar.AsSpan();// diziden AsSpan() metodu ile span türünde bir nesne YANİ span4 'ü oluşturuyoruz..
            ...
            string text = "ben genellikle yaz aylarında balık tutmaktan hoşlanırım.";
